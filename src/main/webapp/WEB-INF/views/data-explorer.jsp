...
<div class="container-fluid py-4">
  ...
  <c:if test="${not noCred and not empty currentCred}">
    ...
    <div class="row g-0">
      ...
      <%-- 左側：Collection 清單 --%>
      <div class="col-md-3 col-lg-2 pe-3">
        ...
        <%-- 新增 Collection（直接透過插入文件建立） --%>
        <div class="card shadow-sm border-0">
          <div class="card-header bg-secondary text-white fw-semibold small">
